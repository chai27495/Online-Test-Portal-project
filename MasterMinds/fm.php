        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">LET'S LEARN
                    <small>Fluid Mechanics</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Fluid Mechanics</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-8">
                ...
                <h2>
                    <a href="#">Fluid Mechanics</a>
                                    ...
                                    <img class="img-responsive img-hover" src="images/FluidMechanicsI_1435826064.jpg" width="500" height="600" alt="">
                                <p>Learn Fluid Mechanics in a easy way.</p>
               
 <iframe src="http://nptel.ac.in/courses/112105171/1" width="1150" height="500" target="_blank"></iframe>
