    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">LET'S LEARN
                    <small>Applied Thermodynamics</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Applied Thermodynamics</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <h2>
                    <a href="#">Applied Thermodynamics</a>
                </h2>
               
                                    <img class="img-responsive img-hover" src="images/download (1).jpg" width="500" height="600" alt="">
                                <p>Learn Applied Thermodynamics in a easy way.</p>
               
 <iframe src="http://www.nptel.ac.in/courses/112106133/" width="1150" height="500" target="_blank"></iframe>
