...
<style>
body {
        background-image: url("images/1902672.jpg");color:black;
} 
...
<li class="dropdown">
    ...
    <!-- Header Carousel -->
    <header id="myCarousel" class="carousel slide"style="carousel:width:640px; height:360px; margin:25px ; align:center;">
        <!-- Indicators -->
...
<div class="item">
     <div class="fill" style="background-image:url('images/4.png');"></div></div>
<div class="item">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"style="background-color:orange;color:black"><b> <font face="Comic sans MS" size="8"> &nbsp Welcome to MasterMinds</font>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i> Why MasterMinds?</h4>
                    </div>
                    <div class="panel-body">
                        <p><li>Provides a platform to test your skills</li>
<li>Provides a platform to gain knowledge</li></p>
                                            </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-gift"></i>User Friendly Experience</h4>
                    </div>
                    <div class="panel-body">
                        <p><li>Provides a user friendly interface</li>
<li>Easy to use</li></p>
                                            </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-compass"></i> Compatible</h4>
                    </div>
                    <div class="panel-body">
                        <p><li>Compatible with different types of devices</li>
<li>Responsive Web Design</li></p>
