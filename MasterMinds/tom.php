...
<li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data toggle="dropdown dropdown-submenu"><font face="Comic sans MS" size="3">ELECTRONICS </font><b class=""></b></a>
                            ...
                            <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data toggle="dropdown dropdown-submenu"><font face="Comic sans MS" size="3">PRODUCTION</font> <b class=""></b></a>
								<ul class="dropdown dropdown-submenu">
									<li><a href="som.php"><font face="Comic sans MS" size="3">SOM</font></a></li>
									<li><a href="tom.php"><font face="Comic sans MS" size="3">TOM</font></a></li>
									<li><a href="thermodynamics.php"><font face="Comic sans MS" size="3">THERMODYNAMICS</font></a></li>
									<li><a href="fluid-mechanics.php"><font face="Comic sans MS" size="3">FLUID MECHANICS</font></a></li>
								</ul>
							</li> 
</ul>  
</li>                
...
<li class="dropdown">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">LET'S LEARN
                    <small>TOM</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Theory Of Machines</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-8">
                ...
                <h2>
                    <a href="#">TOM</a>
                                    ...
                                    <img class="img-responsive img-hover" src="images/l_theory-of-machine_171111122135.jpg" width="500" height="600" alt="">
                                <p>Learn TOM in a easy way.</p>
               
 <iframe src="Theory of Machines-Khurmi.pdf" width="1150" height="500" target="_blank"></iframe>
