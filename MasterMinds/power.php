        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Power Electronics</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-8">
                ...
                <h2>
                    <a href="#">Power Electronics</a>
                                    ...
                                    <img class="img-responsive img-hover" src="images/powerelectronics_logo1.jpg" width="300" alt="">
                                <p>Learn Power Electronics in a easy way.</p>
               
 <iframe src="http://www.tutorialspoint.com/power_electronics/index.htm" width="1150" height="500" target="_blank"></iframe>                
            </div>
