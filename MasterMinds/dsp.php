    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <h2>
                    <a href="#">Digital Signal Processing</a>
                </h2>
               
                                    <img class="img-responsive img-hover" src="images/DigitalSignalProcessing.gif" width="300" alt="">
                                <p>Learn Digital Signal Processing in a easy way.</p>
               
 <iframe src="http://www.tutorialspoint.com/digital_signal_processing/index.htm" width="1150" height="500" target="_blank"></iframe>                
            </div>
