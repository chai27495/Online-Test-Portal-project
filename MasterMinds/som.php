        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Strength Of Materials</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-8">
                ...
                <h2>
                    <a href="#">SOM</a>
                                    ...
                                    <img class="img-responsive img-hover" src="images/dsc02048.jpg" width="500" alt="">
                                <p>Learn SOM in a easy way.</p>
               
 <iframe src="http://nptel.ac.in/courses/112107147/" width="1150" height="500" target="_blank"></iframe>
