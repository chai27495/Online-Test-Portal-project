    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">			   <div class="panel panel-default">
                ...
                <h2><font face="Comic sans MS" size="6">Data Analysis</font></h2>
                <p><font face="Comic sans MS" size="4">Analysis of data is a process of inspecting, cleaning, transforming, and modeling data with the goal of discovering useful information, suggesting conclusions, and supporting decision-making.</font></p>
            </div>
        </div>
        <!-- /.row -->
